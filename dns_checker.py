...
Output: CSV-bestand of HTML-rapport met timestamp.
...
""",
        ...
        "LICENSE.txt": """\
================================================================================
  DNS CHECKER — Licentie
  Copyright (c) 2026 Sigurd Felix
================================================================================

VRIJE GEBRUIKSLICENTIE MET NAAMSVERMELDING
(Attribution-Required Free Use License)

Iedereen mag dit script vrij gebruiken, kopiëren, aanpassen en verspreiden,
ook voor commerciële doeleinden, onder de volgende voorwaarden:

1. NAAMSVERMELDING IN RAPPORTAGES
   Alle rapporten en uitvoerbestanden die met dit script worden gegenereerd,
   dienen een verwijzing te bevatten naar de auteur:

     "© Sigurd Felix — dns_checker.py"

   Deze vermelding mag niet worden verwijderd of gewijzigd, ook niet bij
   gebruik van aangepaste versies van het script.

2. NAAMSVERMELDING IN DE CODE
   De auteursinformatie in de broncode mag niet worden verwijderd of gewijzigd.
   Bij doorontwikkeling dient de originele auteursnaam bewaard te blijven,
   eventueel aangevuld met de naam van de aanpasser.

3. GEEN GARANTIES
   Dit script wordt aangeboden zoals het is ("as is"), zonder enige garantie.
   De auteur is niet aansprakelijk voor enige schade die voortvloeit uit het
...
Samengevat: gebruik het vrij, maar laat mijn naam er altijd in staan.

  Sigurd Felix
  sigurd@forevertoday.nl
  Forever Today B.V.
...
Functionaliteit:
  ...
  - Vrije gebruikslicentie met verplichte naamsvermelding (Sigurd Felix)
